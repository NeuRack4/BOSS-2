  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <BarChart data={data} margin={{ top: 8, right: 16, left: 0, bottom: 0 }}>
        ...
        />
        <Bar dataKey="revenue" name="매출" fill="#c47865" radius={[4, 4, 0, 0]} />
...
```json
{
  "data": {
    "trend": [
      { "period": "2026-01", "revenue": 3200000, "prev_revenue": 2800000, "change_pct": 14.3 },
      { "period": "2026-02", "revenue": 2850000, "prev_revenue": 3200000, "change_pct": -10.9 }
    ],
    "summary": {
...
```json
{
  "data": {
    ...
    "peak_hours": [9, 10, 13],
    "heatmap": [
      { "dow": 1, "hour": 9, "tx_count": 12, "total": 60000 }
    ]
  }
}
```
