...
function MenuRow({ menu, maxMargin, categoryColorMap }: {
  ...
  return (
    <div className="flex items-center gap-2 rounded-lg px-3 py-2 hover:bg-slate-50">
      ...
      {/* 메뉴명 */}
      <div className="w-32 shrink-0 truncate text-xs font-medium text-slate-700">
        {menu.name}
      </div>

      {/* 마진율 바 */}
      <div className="w-28 h-2 shrink-0 overflow-hidden rounded-full bg-slate-100">
        <div
      ...
      {/* 마진율 % */}
      <div className={`w-10 shrink-0 text-right text-xs font-bold ${hasCost ? color.text : "text-slate-300"}`}>
      ...
      {view === "margin" && (
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="flex items-center gap-3 border-b border-slate-100 px-3 py-2">
            ...
            <div className="w-32 text-[10px] font-semibold text-slate-400">메뉴명</div>
            <div className="w-28 text-[10px] font-semibold text-slate-400">마진율</div>
